/**
 * Push Mum2Baby Choices lessons to Supabase as training_videos.
 *
 * Usage: node scripts/push-m2b-lessons-to-supabase.mjs
 */
...
const PRODUCT_ID = "mum2baby";
const REST = `${SUPABASE_URL}/rest/v1/products?id=eq.${PRODUCT_ID}`;
const PROPS_DIR = resolve(__dirname, "../../my-video/.tmp/m2b-props");
const GH_RELEASE_BASE =
  "https://github.com/leotansingapore/aia-product-compass-hub/releases/download/m2b-videos";

// -- Lesson definitions (order matters) --
const LESSON_IDS = [
  "m2b-m1-l1", "m2b-m1-l2", "m2b-m1-l3", "m2b-m1-l4", "m2b-m1-l5", "m2b-m1-l6",
  "m2b-m2-l1", "m2b-m2-l2", "m2b-m2-l3", "m2b-m2-l4",
];
...
// Remove any previous m2b- entries before merging
const filtered = existing.filter((v) => !v.id.startsWith("m2b-"));
...
console.log(`  M2B entries:`);
for (const v of vids.filter((v) => v.id.startsWith("m2b-"))) {
