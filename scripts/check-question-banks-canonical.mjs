...
const checks = [
  ...
  },
  {
    ...
    badPatterns: [
      { pattern: /3\.6\s*%\s*p\.?a\.?\s*(deducted\s+monthly\s+)?for\s+(the\s+)?first\s+10\s+(policy\s+)?years/i, reason: 'PWV Supplementary Charge runs 7 years at 3.60% (PWV 2.0 PS v1.0 042025), not 10' },
      { pattern: /minimum\s+annual\s+premium\s+(is\s+)?S?\$\s*7,?800/i, reason: 'minimum annual premium is S$18,000 (PWV 2.0 PS v1.0 042025), not S$7,800' },
      { pattern: /S?\$\s*7,?800.*minimum\s+(annual\s+)?premium/i, reason: 'minimum annual premium is S$18,000 (PWV 2.0 PS v1.0 042025), not S$7,800' },
      { pattern: /investment\s+bonus.*7\s*%.*one[-\s]?time.*year\s+8/i, reason: 'Investment Bonus is 2.5% x 4 (Y8-Y11), not 7% one-time at Y8' },
      { pattern: /7\s*%\s+(of\s+annualized?\s+(regular\s+)?premium\s+)?(paid\s+)?(once\s+)?at.*year\s+8/i, reason: 'Investment Bonus is 2.5% x 4 (Y8-Y11), not 7% one-time at Y8' },
      { pattern: /performance\s+bonus.*0\.30?\s*%.*year\s+9/i, reason: 'Performance Bonus is 0.40% p.a. of RPPV from Year 8 (PWV 2.0 PS), not 0.30% from Y9' },
      { pattern: /performance\s+bonus.*0\.50?\s*%.*year\s+8/i, reason: 'Performance Bonus is 0.40% p.a. of RPPV from Year 8 (PWV 2.0 PS), not 0.50%' },
      ...
      { pattern: /5\s*year\s+premium\s+term.*not/i, reason: 'PWV 2.0 IS a 5-year premium term \u2014 do not negate' },
    ],
  },
];
