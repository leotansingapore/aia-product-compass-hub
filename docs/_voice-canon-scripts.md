---
title: "Voice Canon - Script Writing for FCs"
audience: writers, editors, AI subagents
status: canonical
last_updated: 2026-04-29
applies_to:
  - docs/first-60-days/**
  - docs/next-60-days/**
  - any FC-facing WhatsApp / DM / call / email script in this repo
do_not_apply_to:
  - canonical AIA training scripts (Market Survey verbatim, ABCD Four Promises, official objection-handling tables) - those are quoted curriculum and stay as-is
---

# Voice Canon - FC-Facing Scripts
...
3. **Different perspective** (the new info): one sentence
4. **Safety valve**: *"would [day/time] still work for a quick chat?"* — return to the appointment ask, low pressure
...
## 5. Anti-patterns (and how to fix them)
