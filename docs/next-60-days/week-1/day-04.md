...
primary_sources:
  ...
  - "[[../_source-holos-decks/your-story]]"
...
```mermaid
flowchart LR
    W["Write v1<br/>(20 min)"] --> R["Read aloud<br/>(5 min)"]
    R --> L["Listen back<br/>(5 min)"]
    L --> M["Mark flat spots<br/>(5 min)"]
```
...
**Q1. The 4-part story frame runs in what order?**
- A) Villain → Life today → Guide → Growth
- B) Life today → Villain → Guide → Growth ✓
...
- Previous: [[day-03|Day 3 — Your 90-Day Scorecard]]
- Next: [[day-05|Day 5 — Tonality & Salesmanship]]
- Week 1 overview: [[README|Week 1 — Reset & Activate]]
- Callback: [[day-01|Day 1 — The 4-part story frame]]
