...
big_idea: "A testimonial earns trust only if it shows the before, the during, and the after. Miss one beat and it reads as a claim instead of evidence."
kpi_link: "Week 3 KPI — 3 posts shipped; 5 DMs opened"
primary_sources:
  - "[[../_source-articles/5-questions-building-trust]]"
  - "[[../_source-articles/instagram-selling-secrets-eric-feng]]"
duration_minutes: 20
tags: [next-60-days, week-3, new-fc, testimonials, social-proof, content]
---
