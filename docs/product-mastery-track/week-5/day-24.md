...
> **Today's frame:** Objections are the points where the prospect tells you which conviction they need to hear next. An FC who can deliver these five stories on demand — without notes, without flinching — closes meetings that less prepared FCs lose. HSGM then becomes the door-opener for the whole AIA stack.

Part 1 covers the 5 objections. Part 2 covers cross-sell and bundling.
...
By the end of Part 1 you should be able to recite all 5 responses from memory, deploy the brochure-page-9 Tom example for Objection 3, and recognise which arc the prospect is on within 60 seconds of them speaking.
...
> *"That's totally fair — MediShield Life is the foundation, and it's great that we all have it. Honestly though, the way it's sized — for B2 and C-class wards in public hospitals — means the moment you upgrade your ward or step into a private hospital, the bill is pro-rated. A S$200,000 private hospital bill: MediShield Life pays roughly the public-ward equivalent, and you absorb the rest. That gap is what HSGM closes.*
>
> *Even people who say they'll only ever go public usually end up wanting at least the B Lite plan, because in a real emergency the ambulance doesn't ask which ward you wanted. Does it feel reasonable to at least see what the B Lite numbers look like for you?"*
...
> *"That makes sense — corporate cover is genuinely good while you have it. Three things worth thinking through.*
>
> *First, it disappears when the job disappears — career break, retrenchment, retirement, even a normal job switch. That's exactly when you might need it most.*
>
> *Second, it usually excludes pre-existing conditions, so anything that surfaces while you're with this employer can become uninsurable later if you lose the cover.*
>
> *Third, the annual caps on corporate medical are typically well below S$2 million.*
>
> *HSGM is portable, lifetime, and yours regardless of where you work. The clean move is to layer HSGM underneath the corporate plan now, while you're healthy and underwriting is straightforward. Worth running a quote so you can see exactly what the gap closure looks like?"*
...
**The script (cushion → reframe with math → trial close):**

> *"Honestly, fair — and it's the same question I'd ask if I were sitting where you are. Let me sketch out what the math looks like without the rider.*
>
> *Your maximum exposure on a single bill is the deductible plus 10% co-insurance. On a S$100,000 bill, that's S$3,500 plus S$9,650 — about S$13,150 out of pocket. On a S$1 million bill, the 10% co-insurance alone is roughly S$99,650.*
>
> *So the rider isn't really a luxury — it's what stops a S$1 million event from becoming a S$100,000 personal bill. With AIA Max VitalHealth Pro A, you pay 5% capped at S$6,000 a year, full stop, provided you're treated by a preferred provider OR you've got pre-authorisation OR it's an A&E referral from a Singapore hospital. For a young adult, that rider is roughly S$60 to S$80 a month for private.*
>
> *Does that math change how you'd think about whether to take it?"*
...
**The script (cushion → three-reason walkthrough → trial close):**

> *"Totally fair — the cash gap between A and B is real. Three things worth weighing.*
>
...
>
> *Third — the one most people miss — flexibility. If you start with Plan A and later decide it's too expensive, you can downgrade to B with no fresh underwriting. But if you start with B and later want to upgrade to A, you face full underwriting again. By then, if anything has shown up on a medical report, you may not qualify.*
>
> *Plan A now buys you the option to stay or step down. Plan B now closes the upgrade door. Neither is wrong — it depends on which version you'd regret less. Want me to show you what each looks like for your age band?"*
...
> *"That's a fair question — most people I sit with want to know they're not locked in. Two things to know.*
>
> *HSGM is portable — it's yours regardless of employer. If you ever want to switch insurers, the IP system handles it on the back-end: when your new policy is approved, the old one auto-terminates. You don't have to call customer service.*
>
> *The catch is medical underwriting. If you've made claims or developed any condition between now and then, the new insurer can decline you, load your premium, or exclude the condition. Switching is easy when you're healthy and hard when you're not — which is exactly why locking it in now matters.*
>
> *On the AIA side specifically — the SMA IP Providers Survey 2022 (published August 2023) ranked AIA #1 across all six metrics, with overall rating 3.86 against Prudential 3.27, NTUC 3.22, AXA 2.56, GE 2.50 (8world.com/singapore/ip-providers-ranking-2161476). So the case for switching out later is usually weak — but the choice stays yours. Does that line up with how you'd want it to work?"*
...
- AIA was rated #1 across all 6 metrics in the SMA IP Providers Survey 2022 — that removes most prospects' rationale for switching out
...
When a prospect drifts back to "let me just stick with what I have", cushion before reframing:

> *"Totally fair — what you have today works today. The thing worth pressure-testing is what works in 5 years, when you're slightly older, possibly with a condition on file, possibly without the corporate cover. Locking the foundation now, while underwriting is clean, gives you the option to adjust later from a position of strength. Mind if I show you what the cost of waiting actually looks like?"*
...
## The HSGM-to-APA pivot (Video 30)
...
> *"Out of curiosity — has anyone shown you what your lifetime hospital premium adds up to? Most pre-retirees I sit with are surprised: it lands around S$300,000. Worth asking — instead of just paying that as an expense, what if a dividend-paying plan like APA generated the income that paid those premiums for you, for life? Today's protection AND tomorrow's premium-paying capacity in one architecture."*
...
```mermaid
flowchart TD
    A["1. HSGM (today)<br/>Hospitalisation foundation"] --> B["2. Personal Accident<br/>SEPARATE plan — fills the outpatient gap below HSGM"]
    B --> C["3. CI / SFT / GPP / UCC<br/>Lump-sum income replacement during recovery years"]
    C --> D["4. APA accumulation<br/>The asset that pays future premiums (Video 30 pivot)"]
