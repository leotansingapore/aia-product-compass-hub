...
**Example — speculation:** Buying a "hot" cryptocurrency because a YouTube influencer said it would 10×. Selling when it drops 20%.
...
Recommending aggressive portfolios to conservative clients → they panic on the first market drop → they sell at the bottom → they distrust you and the industry forever.
...
1. **The core difference between investing and speculation:**
 - A) Amount invested
 - B) Time horizon and intent — ownership/compounding vs short-term timing ✓
 - C) Type of asset
 - D) Tax treatment
