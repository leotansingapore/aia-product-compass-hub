...
> **The TVM material has been consolidated.** All Time-Value-of-Money content (concept, the 5 variables, FV and PV, lump sum vs regular, discounting, multi-goal client, inflation-adjusted returns, time-horizon-to-rate mapping, the 10 practice problems, common error patterns, the live client speed test) lives on **[Day 28 - Time Value of Money: The Complete Reference](../week-5/day-28.md)**. Today's job is to *use* it, not re-read it.

## What you'll walk away with

By the end of today you should be able to:

1. **Solve 3 random TVM problems** from Day 28 Section 13 in under 60 seconds each, without looking at the answer.
2. **Run a live PV calculation** in front of a friend / spouse / sibling acting as a prospect.
3. **State** the 5 most common error patterns from Day 28 Section 14 from memory.
...
- [ ] Set BGN mode.
- [ ] Run a sanity check: $1,000 today at 6% for 10 years gives FV around $1,791.
- [ ] Switch to END mode, run the same and confirm the same answer (no PMT involved). Then add PMT = $100/yr to confirm BGN gives a slightly higher FV than END.

### Block 2 - Random 3-of-10 (10 min)

Pick **3 random problems** from [Day 28 Section 13](../week-5/day-28.md). Don't peek at the solution.

- [ ] Time yourself per problem.
- [ ] Write the **client-friendly version** for each.
...
**Pass criteria:** under 90 seconds from question to answer. If you can't yet, return to Day 28 Section 6 worked examples and re-drill.
 ...
 **Why:** FV = $250,000, n = 216 months, i = 0.5% per month, PV = 0, BGN gives PMT around -$640/month. (See Day 28 Section 13 Problem 2.)

2. **The single biggest credibility move when running TVM live with a client is:**
 - A) Showing the formulas in detail
 - B) Translating the calculator output into one client-friendly sentence (correct)
 - C) Running multiple scenarios at once
 - D) Quoting historical market returns from memory

 **Why:** Day 28 Section 15 - clients don't need to see the math, they need to see the *answer*. The translation from calculator output ("PMT = -$1,518") into a usable sentence ("$1,520/month for 25 years gets you to $1M") is the credibility move.

3. **A new FC scores 6 of 10 on the practice set. The right next step is:**
 - A) Move to Day 32
 - B) Re-read Day 28 sections 1-11 and re-run the set tomorrow (correct)
