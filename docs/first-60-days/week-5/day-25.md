...
If a weekly review starts feeling like ten minutes of self-congratulation, the review is no longer doing its job. If your prospecting block has become a comfortable sit at a familiar cafe where you make a known number of dials to known names, the block has become a holding pattern.
...
1. **Why do weekly rhythms beat monthly goals?**
 ...
 - B) Rhythms are the behaviour layer that holds the week together - targets without behaviours drift (correct)
...
2. **What is the Sunday review for?**
 ...
 - B) Looking back at the week, setting 3 priorities for next week, and calendar-blocking them (correct)
...
3. **What should the daily opening include?**
 ...
 - B) Reviewing today's 3 priorities, picking the most important task first, and deciding what NOT to do (correct)
...
4. **The learning rhythm during the 60 days is:**
 ...
 - B) 15 minutes a day + weekly read-back on Sunday + one practice rep per week (correct)
...
6. **Friday wrap's main purpose is to:**
 - A) Brag about wins
 - B) Close open loops so the weekend starts clean (correct)
...
- Previous: [[../week-4/day-24|Day 24 - The Time Management Matrix]]
- Next: [[day-26|Day 26 - The 10X Rule in Daily Action]]
