...
1. **Apply** the formula **Activities x Skills x Knowledge = FYC** to diagnose which factor is your weakest link.
2. **Build** a weekly scorecard that tracks the inputs, not just the outputs.
3. **Aim** for the FYC-in-first-90-days x 4 benchmark - and know what it means.
...
- Zero activities x any skill x any knowledge = **zero.**
- High activity x low skill x high knowledge = **low** (because skill is the weakest link).
- High activity x low skill x low knowledge = **very low.**
...
> **Your first 4 years of production should look like: FYC x 4 (quadruple your first-90-days production).**
...
Don't obsess about month-1 income. Obsess about **building the 90-day foundation** that scales to 4x over the coming years.
...
## 6. Activities x Skills x Knowledge diagnostic - the worked example
...
1. **The production formula is:**
 ...
 - B) Activities x Skills x Knowledge = FYC (correct)
 - C) Activities x Time = FYC
 - D) Skills x Experience = FYC
...
2. **"FYC x 4 in first 90 days" means:**
 - A) Your first-90-day FYC should be 4x a typical new FC's
 - B) Aim to reach ~4x your first-90-day production by Year 4 (correct)
 - C) Make 4x as many calls
 - D) Close 4x as many policies
...
4. **Why is the formula multiplicative (x) rather than additive (+)?**
 - A) It makes the math harder
 - B) If any one factor is zero, the result is zero - so all three must be non-zero every week (correct)
...
5. **Running a personal scorecard weekly helps you:**
 ...
 - B) Diagnose the weakest of the three factors and focus the next week's effort on it (correct)
...
6. **An FC with strong outreach but low close rate should:**
 - A) Do 2x more outreach
 - B) Study more products
 - C) Invest in skill reps - role-play, recorded meetings, feedback from a mentor (correct)
