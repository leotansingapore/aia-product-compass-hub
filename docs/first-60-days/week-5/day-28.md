...
**Time Value of Money** is this last insight formalised: **money has a time dimension.** A dollar in hand now is not just a dollar - it's a dollar x (1 + growth)^years.
...
A **single $12,247 lump sum at 9%** does the job of **$3,264/year x 35 years = $114,240** in yearly contributions at 4%. The lump sum approach works if:
...
3. **What mode do most insurance policies use?**
 ...
 - B) BGN (payments at beginning of period) (correct)
 - C) No mode needed
...
4. **Present Value answers the question:**
 ...
 - B) How much do I need today to reach a future target? (correct)
...
7. **A client has four financial goals totalling $5,540/month but only $3,000/month in savings capacity. The best advisor response is to:**
 ...
 - C) Use the math to surface the trade-off and discuss extending timelines, reducing targets, or increasing income (correct)
...
8. **A client watches you run a TVM calculation in under 90 seconds during the meeting. The primary advisor benefit is:**
 ...
 - C) It demonstrates real-time competence and builds instant credibility (correct)
