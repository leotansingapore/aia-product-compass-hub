...
## 1. From slogan to schedule

Day 18 introduced the five principles of the 10X Rule. Most new FCs read them, get inspired for 3 days, then drift back to their original activity level.

The reason: **slogans don't run careers. Calendars do.**

Today you put the 10X Rule on the calendar in a way that makes drift visible and friction-inducing.
...
- Proposal writing (over-polishing is wasted).
...
This is the most important exercise of the week. Take 10 minutes, commit to specific numbers.
...
**Rule:** even on MAD days, hit a bare minimum. Protecting the bare minimum is what protects the streak.

| Day type | Outreach | Content | Role-play |
|---|---:|---|---:|
| Full day | 20 | Draft/post | 1 |
| Partial day | 10 | Half-draft | 0 |
...
**Before 10X'ing, ask:**
- Is this the **most important** outreach I could make right now? (The warm lead you've been ignoring vs another cold call.)
...
The goal is not a perfect streak. The goal is a **durable pattern** that survives missed days.

## 7. The "effort doesn't equal target" principle

Grant Cardone's core insight: **the 10X Rule assumes the target is never the problem; the effort is.**

When you miss your weekly outreach target:
- Lazy response: "Target was unrealistic."
- 10X response: "What blocked the effort this week? Time allocation? Energy? Distractions? Skill gap?"

Diagnose the effort layer. Fix what blocked you. Keep the target.

This is the psychological move that separates 10X practitioners from people who read the book once.
