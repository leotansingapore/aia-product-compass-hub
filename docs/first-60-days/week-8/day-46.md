...
The four styles also map onto two axes - **task-oriented vs. people-oriented**, and **outgoing vs. reserved**:

| Style | Pace | Focus | Drivers |
|---|---|---|---|
| **D - Dominant** | Outgoing | Task-oriented | Results, control |
| **i - Influential** | Outgoing | People-oriented | Recognition, fun |
| **S - Steady** | Reserved | People-oriented | Relationships, stability |
| **C - Conscientious** | Reserved | Task-oriented | Accuracy, data |
...
> "Based on what you've shared, you've got two gaps: CI and hospital. We can close both with a plan at a fixed monthly premium. Want me to send you the specifics by Friday or walk through now?"
