...
1. **The "implied need" stage means:**
 ...
 - B) The client has vague dissatisfaction but hasn't named a problem (correct)
...
2. **The role of Implication questions is to:**
 ...
 - B) Make the client feel the weight/seriousness of the problem (correct)
...
3. **A client buys when:**
 ...
 - C) Seriousness of problem > cost of solution (correct)
...
4. **A prospect says "the premium feels expensive." Based on the buy/don't-buy scale, the best response is to:**
 ...
 - C) Explore whether the seriousness of the problem has been fully felt - the price objection often signals an underweighted problem (correct)
...
5. **Need-Payoff questions work because:**
 ...
 - C) The client articulates the value of solving the problem themselves - they sell themselves (correct)
...
6. **An FC jumps straight into presenting a retirement plan after 10 minutes of Situation questions. What has likely been skipped?**
 - A) The rapport phase
 - B) Problem and Implication questions - the client's need hasn't been made explicit or felt yet (correct)
...
7. **"You are a consultant, not a salesperson" means, in practice:**
 ...
 - C) Lead with questions and insight; let trust - not persuasion - drive the relationship (correct)
