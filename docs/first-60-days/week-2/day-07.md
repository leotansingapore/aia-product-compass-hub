...
|---|---|---|
| **Death / TPD** | Your dependents lose your income | **10x annual income** (replaces ~10 years of earnings) |
| **Critical Illness** | 3-5 year recovery period without income; home modifications | **5x annual income (Major CI)** + **2x (Early CI)** |
...
| **Savings / Investments** | Retirement - no income, still alive and healthy | Depends on target retirement income x longevity |
...
1. **Which segment typically uses a 10x annual income rule of thumb?**
 - A) Critical Illness (Major)
 - B) Hospitalisation
 - C) Death / TPD (correct)
 - D) Savings / Investments

 **Why:** The 10x annual income rule replaces approximately 10 years of earnings for dependents after a death or TPD event. Critical Illness uses 5x (Major CI) plus 2x (Early CI) to cover the recovery period. Hospitalisation targets maximum limits by hospital tier, not a salary multiple. Personal Accident reimburses outpatient accident expenses, also not a salary multiple. Savings and Investments are sized against the retirement income target, not a fixed income multiple.
...
2. **Which tool would you use to submit an application on the spot at a client's home?**
 ...
 - B) iPos / iMO (the iPad point-of-sale) (correct)
 - C) WhatsApp
...
3. **In one phrase, AIA's mission is to help people live:**
 ...
 - B) Healthier, longer, better lives (correct)
...
4. **A client says, "My mum was just diagnosed with cancer." Which segment should this raise in your mind first?**
 ...
 - B) Critical Illness - the salience event signals a gap to review (correct)
...
5. **A prospect asks, "Why AIA instead of a broker?" The most honest and accurate response is:**
 ...
 - B) A tied agent goes deeper on one insurer's products, which leads to better-fitted recommendations (correct)
...
6. **Which scenario best illustrates the "silent labelling" habit from today's lesson?**
 ...
 - B) Listening to a client mention a promotion and mentally flagging Death/TPD and Savings needs (correct)
...
7. **You are about to meet a new client. You have iSmart on your phone but forgot to charge the iPad with iPos. What is the impact?**
 ...
 - B) You can share campaign updates but cannot complete a straight-through application on the spot (correct)
