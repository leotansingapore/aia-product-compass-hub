...
## Recap - the three cash-flow patterns from Day 9

Day 9 showed *what happens* to a dollar once it lands in someone's hands. Three classes, three behaviours:
...
2. **Which of these are mechanisms that turn an FC from S into B over time? (Select all that apply.)**
 - A) Recruiting and mentoring a team of advisors whose production you earn override commissions on (correct)
 - B) Making more cold calls each week
 - C) A renewal income that produces recurring income regardless of daily effort (correct)
...
3. **Non-recurring revenue means:**
 - A) Monthly income
 - B) You do the work once and get paid once (correct)
...
4. **A freelance graphic designer charges $5,000 per project. She works for herself and sets her own hours. Which quadrant does she occupy?**
 ...
 - B) S - she is self-employed and income stops when she stops (correct)
...
5. **An FC in Year 6 has 300 active clients, two junior associates she mentors, and a referral engine that generates 4 new leads per month without her active involvement. Which quadrant shift best describes her situation?**
 ...
 - B) Transitioning from S into B - a system runs without requiring her daily effort (correct)
...
6. **Why does school training make the E-to-B quadrant shift harder for most people?**
 ...
 - B) School optimises students to follow instructions and defer to authority, reinforcing the E mindset (correct)
...
7. **A new FC is debating whether to leave because Year 1 commissions are low. The cashflow quadrant lesson suggests the most important question to ask is:**
 ...
 - B) "Is my renewal income growing in a way that will shift me from S toward B over time?" (correct)
...
8. **A Year-1 FC is wondering when to start thinking about recruitment. Based on Day 11, what's the strongest counsel?**
 ...
 - B) Refer warm-market candidates to your upline from Day 1 - your mentor and the agency system carry the deeper conversations and the training, while you build the recruiting muscle in parallel (correct)
