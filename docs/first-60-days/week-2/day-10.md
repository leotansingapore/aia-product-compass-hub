...
- Total needed (ignoring returns): $9,050 × 12 × 25 = **~$2.72M**

**Path B: passive income from capital**
- At a 4% safe withdrawal rate: $9,050 × 12 ÷ 0.04 = **~$2.72M** — same number, different mental model.
...
**Don't sell products. Sell an income stream.** A ₁ million saving plan means nothing to a client. "$4,500 a month, for life, starting at 65" means everything.
...
1. **The formula for financial freedom is:**
 - A) Net worth > $1M
 - B) Passive income > Monthly expenses ✓
...
3. **The better way to motivate a retirement client:**
 ...
 - B) Frame it as a monthly income stream that starts when their salary stops ✓
