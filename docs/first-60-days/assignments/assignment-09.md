...
> **The gist.** Build two clean one-page Policy Summaries in the [Total Wealth Concept tool](https://present.financeillustrator.com/policy-summary-builder/summaries/v2) - one for yourself, one for a family member - and submit a screenshot of each. You practise the skill every client conversation eventually needs: turning a pile of policy documents into one page a normal person can read. Starting with your own coverage means you know it cold before you sit across from anyone else.

![Total Wealth Concept Policy Summary Challenge overview: build two, understand more, protect better. The mission is to build two clean one-page Policy Summaries in the Total Wealth Concept tool - one for yourself, one for a family member - and submit a screenshot of each, practising the skill every client conversation needs of turning a pile of policy documents into one page a normal person can read. The shape of it runs in seven steps: map your own policies first, ask a family member for theirs, recognise each plan using the Singapore Competitor Product Inventory, enter each policy in the tool, walk through each summary together, screenshot each while blurring personal info, and book a session with Leo on the recommendations. Why these two: your own portfolio is the one you can never be vague about, and a family member's is real, messy, and the next step up. The result is two clean one-page summaries, a clear view of what you're covered for and what's missing, a real conversation that leads to better decisions, and a review session with Leo. Turn documents into clarity, and clarity into confidence.](/first-60-days/images/policy-summary-challenge.webp)
