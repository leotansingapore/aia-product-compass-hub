...
icon: users
deliverable: "Call logs + 2 appointments booked with senior shadow confirmed"
...
1. **New business number + WhatsApp Business** on the same phone. Ideally a second phone to dial two lines at once.
2. **Ask Leo for cold leads** — unlimited for your first 3 months.
3. **[SMA checklist](https://nsgukkz32942.sg.larksuite.com/wiki/WZiRwAtHgipbzfklv0ClplaMgzb)** — complete before running any ads.
4. **Pin [the prospecting doc](https://nsgukkz32942.sg.larksuite.com/wiki/OTW3wipXSi0y8nkU5l3llk3Vgrb)** to your Lark sidebar.
5. **Log your numbers daily** at [track.themoneybees.co/dashboard](https://track.themoneybees.co/dashboard).

Full setup walkthrough: [Leo's prospecting daily Loom](https://www.loom.com/share/744a0b57822a464dbf6f98301ef1b6fb).
