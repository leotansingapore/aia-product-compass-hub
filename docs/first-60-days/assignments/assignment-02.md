...
Every FC who fails in their first 2 years fails at the same point: they run out of people to talk to by Month 3. Not because they don't know anyone - because they never built the list. This is the single highest-leverage hour of your first 60 days: every conversation, every survey, and every appointment for the next year comes off this sheet.

Use the ready openers below and make one your own - you don't need to write anything from scratch.
...
### Your ready openers (copy and tweak - don't write from scratch)
...
#### Rules of thumb when you tweak one
...
You don't write a playbook for this. The openers you need are already above. For everything else - objection replies, follow-up timing, referral asks - use what's already built rather than writing your own:
...
## Next: put the list to work

The list is only half the engine. The next assignment, **[Market Survey Practice](/learning-track/pre-rnf/assignments/market-survey-practice)**, is where you run 30 warm-market surveys off these names - the reps that make the script yours before your licence drops. Build the list here first; the surveys come off it.
