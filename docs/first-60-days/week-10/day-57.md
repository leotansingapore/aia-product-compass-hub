...
2. **Lump sum needed:** $3,894 x 12 x 35 retirement years = **~$1.6M**.
3. **Two drawdown methods:**
   - **Capital Preservation (4% rule):** withdraw 4%/yr forever. $1.6M x 4% = ~$65K/yr. Capital stays intact *if* investment return >= withdrawal rate.
...
4. 18,518 x $0.019 = **$351 per quarter** in dividend income
...
40-year-old invests $30K/year x 5 years into Global Adventurous Income Fund:

- Dividends reinvested at ~8% (6-7% dividend + ~2% capital growth)
- At age 65: accumulated value **~$585K**
- Switch to receive dividends at 7%: $585K x 7% / 12 = **~$3,400/month passive income**
...
40-year-old, $30K/year x 5 years ($150K total), Elite Adventurous fund at 8%:
...
Total payout = monthly income x 12 x payout years. Divide by premiums paid = **return multiple**.

> *"$4,883 x 12 x 15 = $878K total payout / $120K premium = **7.3x return**. That's the leverage you get from a structured retirement product vs leaving the money in fixed deposit."*
...
Child age 0-1: $6K/year x 5 years = **$30K**. At 21 (university): grows to **~$85K** at 8%. If child gets scholarship and money stays invested -> at 65 compounds to a massive retirement fund (~$8K/month income).
...
$2.8M portfolio x 6.3% dividend yield ~ **$3.6M of dividends over 20 retirement years**. On a US-domiciled S&P ETF: **$1.08M withheld by the IRS**. Irish-domiciled: ~$540K. AIA ILP structure: **$0 at client level**. A million-dollar gap purely from fund domicile.
...
The math on a $2M retirement portfolio: **0.7% x $2M = $14,000 per year** removed from the policy, every year, forever. Over a 30-year retirement, that's **$420K leaving the portfolio just to fees**.
...
> **The pitch:** *"Option 1 - pay $60K over 30 years, get nothing back if you outlive the term. Option 2 - pay $120K over 10 years, double the cost, but you potentially get back 2x your premiums plus profit. Which would you prefer?"*
...
7. On surrender or maturity, the client receives the **cash value** (number of units x current unit price).
...
![What this means: Year 1, 15-50% to funds; Year 2, 50-70% to funds; Year 3, 80-95% to funds; Year 5+, ~100% to funds; Long-term hold.](/first-60-days/images/day-57-m0.webp)
...
1. **When does most of an ILP premium actually go into investment funds?**
   - A) Year 1
   - B) After Year 3 - the first 1-3 years have front-loaded fees (correct)
   - C) Year 10
   - D) Always 100%
...
2. **Which client should NOT buy an ILP?**
   ...
   - B) 50-year-old with 5-year horizon who needs the money (correct)
...
4. **A client surrenders their ILP after 18 months because of a job loss. What outcome should you have warned them about at point of sale?**
   ...
   - B) Early surrender within the front-loaded years means likely receiving back less than total premiums paid (correct)
...
5. **A client with a 20-year ILP has watched markets drop 25% this year. She wants to switch all funds to cash. What is the correct guidance?**
   ...
   - B) Discuss the rebalancing policy: switching entirely to cash during a downturn locks in losses and removes long-term recovery potential; review her risk tolerance first (correct)
...
6. **Why is an ILP described as "investments wrapped in an insurance policy" rather than simply an investment account?**
   ...
   - B) The insurance wrapper provides forced savings, a death benefit, and tax-advantaged structure - but also adds insurance charges and admin fees (correct)
...
7. **A 45-year-old client who is a sophisticated investor, already DCA-ing into ETFs monthly, asks whether an ILP adds value. What is your honest answer?**
   ...
   - B) Not likely - a cost-sensitive investor with existing discipline benefits less from the wrapper since the fees outweigh the forced-savings advantage (correct)
