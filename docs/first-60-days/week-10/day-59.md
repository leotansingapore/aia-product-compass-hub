...
supporting_sources: []
duration_minutes: 25
tags: [first-60-days, week-10, skills]
---
...
1. **The most important part of a proposal is:**
   ...
   - B) Restating the client's goals in their own language (correct)
...
2. **The Silent Close works because:**
   ...
   - B) The first to speak is usually the most eager - let the client speak first (correct)
...
3. **When a client says "let me think about it" - the best response is:**
   ...
   - C) "Of course. What specifically would you like to think about?" (correct)
...
4. **A client has reviewed the full proposal, nodded along, but has not verbally committed. You say: "Your preferred monthly debit date - 1st or 15th?" Which closing technique are you using?**
   ...
   - C) Assumption Close - assuming forward motion when all signals are positive (correct)
...
5. **You present a plan and ask "Shall we proceed?" The client is silent for 10 seconds. A new FC's instinct is to fill the silence with more options. Why is this a mistake?**
   ...
   - B) Adding choices during silence rewards hesitation, increases decision fatigue, and signals you are eager to concede (correct)
...
6. **Your proposal runs to 14 pages with full illustrations included in the main document. What hygiene rule does this violate?**
   ...
   - B) Proposals over 4-6 pages cause clients to skim, forget key points, and generate more objections - illustrations should be an appendix (correct)
...
7. **A client signs and you have the paperwork ready. She says: "Actually, can I bring this home and sign tonight?" What is the risk, and what is the correct response?**
   ...
   - B) Post-meeting momentum is fragile; handle paperwork immediately where possible, or ask what would make her comfortable completing it now (correct)
