...
## 1. Why policy review matters

Most clients have insurance policies they:
- Bought years ago and never reviewed.
- Barely remember what's covered.
- Have changed life stages since (marriage, kids, new house, new income).
...
## 2. What a policy summary actually contains

Every policy comes with a summary document. Whether printed or digital, the sections are similar across insurers.

### Key sections

| Section | What's in it |
|---|---|
| **Policy details** | Policy number, start date, end date (if term), premium frequency |
| **Insured person** | Name, age at inception, gender |
| **Policy owner** | May differ from insured (e.g., parent paying for adult child) |
| **Beneficiaries** | Who receives the payout on death |
| **Sum Assured** | The main coverage amount |
| **Premium** | Amount, frequency, term (pay for X years) |
| **Riders** | Additional coverages attached (CI, hospital, waiver of premium, etc.) |
| **Exclusions** | Conditions or scenarios NOT covered |
| **Cash value (if applicable)** | Current surrender value |
| **Maturity benefit (if applicable)** | Payout at end of term |
| **Payout structure** | Lump sum, annuity, coupons, etc. |
...
- **Critical Illness rider** (Major + Early).
- **Waiver of Premium** (if you're disabled, premiums stop).
- **Multiplier rider** (increased coverage during high-need years).
- **Multi-pay CI** (multiple payouts for recurring illnesses).

Each gap is a potential recommendation.

### 3. What are the exclusions?
Common exclusions to review:

- Pre-existing conditions (if the client had health issues at policy start).
...
- Do they have kids now?
- Are the original beneficiaries still alive / still appropriate?

**Rule:** every policy review should include checking beneficiaries. Many clients have outdated nominations.

### 5. Is the payout structure right for their life stage?
- A 25-year-old might have chosen **accumulation** (maturity lump sum).
- By 45, they may benefit from a **coupon-paying** structure for income during retirement.
...
Let them answer. Typically they pick the largest gap. You now have their **own-voice priority** for your recommendation.

## 5. Common gaps in a typical client's existing portfolio

After dozens of reviews, the patterns become clear. The most common gaps:

### Gap 1: No or insufficient CI
Most people have life insurance (often from a parent's time). Few have CI. Even fewer have Early CI.
