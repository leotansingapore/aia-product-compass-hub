...
1. **Name** the 7 main product categories AIA offers and what each is for.
2. **Map** a client's need to the appropriate category (not a specific plan).
3. **Distinguish** between Investment-Linked, Whole Life, Endowment, and Universal Life at a conceptual level.

---

## 1. The 7 product categories

When you open the Product Selection page on your iPad (via iPos), you'll see products grouped into these categories:
...
### Wealth-focused ILPs
- Most of the premium goes into investment funds.
- Minimal protection element.
- Best for: clients who want the tax-advantaged insurance wrapper + forced savings + investment growth.

### Protection-focused ILPs
- Mix of protection + investment.
- Insurance charges reduce investment growth.
- Best for: clients who want coverage with some long-term growth potential.

### Sub-types by payment structure
...
- Client has a 15+ year time horizon.
- Client understands that returns are market-linked and non-guaranteed.
- Client wants a structured, disciplined way to invest.
- Client wants the option of protection embedded.

### When NOT to use ILPs

- Client needs capital preservation (use endowment / bonds).
...
**Common features:**
- Death / TPD coverage included.
- Optional Critical Illness riders (Early CI, Major CI, Multi-pay CI).
- Builds cash value over time.
- Some include yearly coupons (income during the policy life).
...
**Common features:**
- Fixed savings period (10, 15, 20 years typically).
- Guaranteed + non-guaranteed (bonus) returns.
- Some plans pay yearly coupons; others accumulate and pay lump sum at maturity.
- Most include Death / TPD coverage; some offer CI rider options.

### Key sub-types

| Type | What's distinctive |
|---|---|
| **Coupon-paying endowment** | Yearly coupons during the policy; good for income planning |
| **Lump-sum maturity endowment** | No coupons; payout at end; best for long-term goals (retirement, education) |
| **Retirement-style endowment** | Guaranteed monthly income for a fixed period from a selected retirement age |
| **SRS-eligible endowment** | Can be purchased using SRS funds for tax relief |
...
### When NOT to use Universal Life
...
When a fact-finding meeting reveals specific needs, map to categories like this:

| Client need | Category |
|---|---|
| "I want to protect my family if I die" + long-term | Whole Life or Term |
| "I want to cover my mortgage for 25 years" | Term |
| "I want CI protection" | Whole Life with CI rider, or standalone CI |
| "I want to invest + some protection" | ILP (wealth-focused) |
| "I want a savings plan for my kid's education" | Endowment |
| "I want lifelong coverage with cash value" | Whole Life |
| "I have $X lump sum, want to grow it" | Single Premium ILP or Endowment |
| "I need max hospital coverage" | Accident & Health (hospital plan) |
| "I have dependents + limited income" | Disability (income replacement) |
| "High-leverage legacy planning" | Universal Life |
...
## 8. The "no one product covers everything" principle

A new FC's instinct is to find **the one plan** that solves all client needs. That plan doesn't exist.

Every mature client has **multiple policies across categories:**

- Term (for specific time-bound needs like mortgage protection).
- Whole Life (for permanent coverage + CI).
- Endowment (for savings goals).
- ILP (for growth).
