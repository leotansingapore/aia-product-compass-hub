...
> **Where these products map in the live sales script:** the **[Canned Sales Track](/learning-track/first-60-days/reference/ost-script-full)** introduces them as the "3 basic insurances" (Life, Hospitalisation, Personal Accident) on Page 1. The CST gives the client-facing language; this day gives you the actual AIA product names that fulfil each role.
