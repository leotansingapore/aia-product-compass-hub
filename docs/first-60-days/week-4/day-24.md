...
| Quadrant | What lives here | Handling |
|---|---|---|
| **Q1 - Crisis** (Urgent + Important) | Case submission deadlines; client's urgent requests; lapsed case recovery; complaints and claim follow-ups; MCG / persistency breaches | MINIMISE |
| **Q2 - Focus zone** (Not Urgent + Important) | Prospecting and rapport building; fact finding and presentations; closing and objection handling; skills training and coaching; exercise and relationships | FOCUS HERE |
| **Q3 - Distraction** (Urgent + Not Important) | Claim paperwork and form filling; delivering gifts and client admin; agent care queries; non-strategic enquiries | DELEGATE |
| **Q4 - Waste** (Not Urgent + Not Important) | Trivia and busywork; gossip and excessive messaging; doom-scrolling; binge TV and gaming | AVOID |
...
| Quadrant | Typical new FC | Target allocation |
|---|---|---|
| Q1 Crisis | 30% | 15% |
| Q2 Focus | 15% | 60% |
| Q3 Distraction | 25% | 15% |
| Q4 Waste | 30% | 10% |
...
1. **Where should 60% of your productive hours be spent?**
 ...
 - B) Quadrant II (not urgent + important) (correct)
...
2. **Quadrant I tasks typically exist because:**
 ...
 - B) Quadrant II was neglected, so Q2 issues became crises (correct)
...
3. **The "big rocks first" principle means:**
 ...
 - C) Schedule Q2 priorities on the calendar before anything else (correct)
...
4. **An FC spends most of her week chasing policy lapses, compliance deadlines, and urgent client complaints. According to the matrix, this pattern most likely indicates:**
 ...
 - B) She neglected Q2 work earlier, causing Q2 issues to escalate into Q1 crises (correct)
...
5. **Delivering a birthday gift to a client's office falls into which quadrant, and what is the recommended handling?**
 ...
 - C) Q3 - delegate or batch into a single admin block (correct)
 - D) Q4 - avoid entirely
...
6. **A new FC has tracked his week and found the following split: Q1 30%, Q2 15%, Q3 25%, Q4 30%. Which single shift would have the highest impact on his career trajectory?**
 ...
 - C) Moving Q2 from 15% toward 60% by scheduling it on the calendar first (correct)
...
7. **In the "big rocks" analogy, what do the sand and water represent in an FC's weekly calendar?**
 ...
 - B) Q3 admin tasks and Q4 downtime, which fill whatever space remains after big rocks are placed (correct)
