...
1. **The most important factor in wealth building for a 25-year-old client:**
 ...
 - B) Time, through compounding (correct)
...
2. **When should a client shift from accumulation to preservation?**
 ...
 - C) Gradually, as retirement approaches - typically 50s onwards (correct)
...
3. **A single-stream income is risky because:**
 - A) It has higher tax
 - B) If the one stream stops, everything collapses (correct)
...
5. **A 45-year-old client says they'll start investing "in 3 years." What's the most accurate way to quantify the cost of that delay?**
 ...
 - B) Use a retirement calculator to show the gap between "start now" and "start in 3 years" - typically 20-30% of total retirement capital (correct)
...
6. **Which of the following is a SMART retirement goal?**
 ...
 - C) "$6,000/month passive income in today's dollars, starting at age 62, adjusted for 2% inflation" (correct)
...
7. **At a modest 6% annual return, a 25-year-old saving $500/month over 40 years accumulates roughly $1M. The key insight this illustrates is:**
 ...
 - B) Over $760,000 comes from compounding - not from the client's own contributions (correct)
