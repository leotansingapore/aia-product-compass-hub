...
1. **The "not yet" reframe protects your:**
 - A) Ego
 - B) Identity from your current state of competence (correct)
 - C) Commission
...
2. **Which of these is a growth-mindset response to rejection?**
 ...
 - C) "Which objection did I fumble?" (correct)
...
3. **What should you track instead of mood?**
 ...
 - C) Reps - dials, appointments, meetings run (correct)
...
5. **According to the "obstacle is the way" concept, what does every rejection on a cold call actually represent?**
 ...
 - B) A rep that builds the exact skill you're here to develop (correct)
...
6. **Day 4 says fixed-mindset responses can usually be spotted by one specific word. What is the tell?**
 - A) "Maybe"
 - B) "I'm" - an identity claim (correct)
 - C) "Difficult"
 - D) "Not"
...
7. **You just had your best week ever - three closes and a packed calendar. What's the right response?**
 ...
 - C) Keep running the exact same reps at the same intensity - a great week is no reason to ease off (correct)
...
8. **"Successful people form the habit of doing what unsuccessful people don't like to do." What is this principle actually saying?**
 ...
 - C) Successful people aren't fond of the unpleasant tasks either - but their reason for doing them is stronger than their dislike (correct)
...
9. **An FC who consistently picks the harder daily choice (dials over scrolling, prep over winging it) over twelve months will most likely find:**
 ...
 - B) The hard choices start to feel easier, while peers who took the easy path face harder catch-up work (correct)
