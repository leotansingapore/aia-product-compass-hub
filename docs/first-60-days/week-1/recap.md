...
week: 1
recap: true
title: "Week 1 Recap - Foundation & Identity Shift"
duration_minutes: 70
tags: [first-60-days, week-1, recap]
---

# Week 1 Recap - Foundation & Identity Shift

> Live recap call with the team. Trimmed to the core content - Leo walks through Days 1 to 6 (~63 min). Open the lecture notes below to jump to any chapter.

<video src="https://hgdbflprrficdoyxmdxe.supabase.co/functions/v1/recap-video-proxy?key=week-1" controls playsinline preload="metadata" crossorigin="anonymous" style="width: 100%; max-width: 960px; border-radius: 12px; display: block; margin: 1rem auto;">
  <track kind="subtitles" srclang="en" label="English" default src="https://hgdbflprrficdoyxmdxe.supabase.co/functions/v1/recap-video-proxy?key=week-1.vtt" />
</video>
...
### [`38:10`](#t=2290) - [Day 4](/learning-track/first-60-days/day/4) . The obstacle is the way - the discomfort tax
The discomfort itself is the path, not a roadblock. Rejections, slow days, complex products, awkward conversations, late-night study - that's the *thing*, not a thing to get past on the way to the thing. The reason this career is rewarded so highly is exactly because no one else wants to do those parts. Leo's own example: he had a stuttering problem and a fear of public speaking, so he joined Toastmasters - "I went to the social club for the exact thing I was scared of." Closed his first few big cases through that network later. The general rule he uses: **whatever activity feels worst in the short term tends to produce the best result in the long term.** Cold calls, asking for referrals, studying on a Friday night, posting on IG when no one engages - those are the high-leverage ones precisely because most people skip them.
...
- Previous: [Day 6 - Forming Habits That Compound](/learning-track/first-60-days/day/6)
- Next: [Day 7 - The Insurance Industry & AIA Singapore](/learning-track/first-60-days/day/7)
