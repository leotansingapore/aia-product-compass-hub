...
A single household can end up worth **20-50x the first sale** once you trace its full lifetime value across new policies, riders, top-ups, and referrals.
...
1. **What is the definition of being financially free?**
 - A) Earning $10K/month
 - B) Passive income exceeds expenses (correct)
 - C) No debt
 - D) Retired
...
2. **What's the most common reason new FCs quit in Year 1?**
 ...
 - C) Comparing their income vs peers on fixed salaries (correct)
...
3. **What creates real job security in this career?**
 ...
 - C) Multiple income streams including renewal commissions (correct)
...
4. **A friend tells you your job is risky because there's no guaranteed salary. What is the most accurate counter-argument based on Day 3?**
 ...
 - B) "Fixed salaries are also at risk - one reorg and they're gone. Renewals compound year after year, and by Year 5 they often make up more than half of an FC's total income." (correct)
...
6. **An FC has been in the role for 3 years. His renewal commissions now cover half his monthly expenses. According to Day 3's definitions, which stage has he reached?**
 ...
 - C) Neither - he needs full coverage before either term applies (correct)
...
7. **Why do FCs who stay 20+ years tend to be "the most loyal" advisors rather than "the flashiest"?**
 ...
 - B) Longevity depends on a service-focused attitude and strong moral compass, not deal volume (correct)
