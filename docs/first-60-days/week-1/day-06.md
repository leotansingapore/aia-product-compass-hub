...
|---|---|---|
| **Activities** | Planning & prospecting | 5x weekly planning session; 50+ outreach touches |
| **Skills** | Selling (SPIN, closing) | 1x role-play with mentor; 3+ real meetings |
...
Where today's lesson started. 1% better daily for a year = 37x better. 1% worse = basically zero. Pair that arithmetic with the 4-law habit loop and identity-based habits, and you build the operator before the operator has to perform.
...
1. **What's the relationship between goals and systems?**
 ...
 - B) Goals set the destination, systems are the vehicle (correct)
...
2. **The 4 laws for creating a good habit, in order:**
 ...
 - B) Cue, Craving, Response, Reward (correct)
...
3. **What does the 10-70-20 rule say about who makes it in this career?**
 ...
 - B) 10% are top performers, 70% need coaching, 20% leave within 1-2 years (correct)
...
4. **An FC sets a goal to "make 10 calls a day" but has no system in place. By Week 3, motivation fades and call count drops. What does Day 6 say was the real failure?**
 ...
 - C) She built a goal without a system - no scaffolding to fall back on when motivation dropped (correct)
...
5. **You want to break the habit of checking your phone first thing in the morning. According to the 4-law inversion, which action targets the Cue?**
 ...
 - C) Leave the phone in a different room overnight (correct)
...
6. **"I am the kind of FC who prospects every day" is an example of identity-based habit formation. Why is this more durable than "I want to make 10 calls a day"?**
 ...
 - B) Skipping a day violates who you say you are, not just a number - the brain notices (correct)
...
7. **According to the FYC formula (Activities x Skills x Knowledge), an FC who is making plenty of calls but never studies products or practises SPIN will:**
 ...
 - B) Hit a ceiling quickly once prospects ask detailed product questions (correct)
