...
## 1. The content production system

Most new FCs struggle with content for one reason: **they try to write posts on inspiration.** Inspiration is unreliable. Systems are reliable.

### The 3-part weekly system

**Sunday (30 min): Ideation**
- Review the past week's client conversations, news, questions you heard.
- List 5 possible topics.
- Pick 1 for this week's post.
...
- One story or insight per post.
- End with a question or CTA.

### Infographics / Quote graphics
- Use sparingly. Low engagement on their own.
- Useful as "slot-filler" between heavier content.

**Start with ONE format.** Master it. Then add a second format.

## 4. The "Authority / Social / CTA" structure

Every post should hit one or more of these buttons:

### Authority
- Demonstrate competence.
- "Here's how CPF SA's 4% rate works against 2% inflation..."
...
### CTA (Call to Action)
- Invite interaction.
- "DM me 'REVIEW' for a free 20-min check on your own plan."
- "Comment 'INFO' below and I'll share the CPF calculator."
...
**Why this works:**
- You show up in more feeds than just your own posts.
- Prospects discover you through your thoughtful comments.
- Relationships with referral sources strengthen.
- The algorithm favours accounts that engage broadly, not just post.
...
Don't optimise for the wrong metrics.
...
**Lead-indicator metrics (track):**
- DMs received per month.
- First meetings booked from DMs.
- Closes from DM-originated meetings.
- Save/share counts on educational posts (signal of future reference).

**Output metrics (track):**
- Closed clients originating from digital.
...
This matters: **you will see little result in Month 1.**

- Month 1: 4 posts. 3 likes each. Zero DMs. Depressing.
- Month 3: 12 posts. Some posts get traction. Occasional DM.
- Month 6: 24+ posts. Consistent DMs. First client closed from digital.
- Month 12: 50+ posts. Multiple clients from digital. Recognisable in your niche.

Most new FCs quit at Month 2. **They miss the compounding precisely because they stopped at the boring part.**
