...
![Step-by-step retirement Problem diagram - inflation slope from $5,000 to $11,866 a month at age 65, $11,866 x 12 x 20 yrs = $2.8M needed, capital depletion line down to $0, and the reveal card showing 'You need to save $6,781/mth' with capital running out at age 85](/first-60-days/images/retirement-problem.webp)
...
```
$11,800/mth x 12 months x 20 retirement years
= ~ $2.85 MILLION
```
...
```
$2,850,000  /  (35 years x 12 months)
=  ~ $6,800 / month
```
...
- The lump-sum calculation here is intentionally simplified - `monthly x 12 x years` ignores inflation *during* retirement and assumes flat drawdown. When you move to a real plan, use proper iResource illustrations.
...
1. **What are the 5 inputs you capture before drawing anything?**
 ...
 - B) Current age, retirement age, life expectancy, inflation rate, target monthly lifestyle (correct)
...
2. **In Step 2 of the Problem diagram, why do you ask the client to guess the inflated number before revealing it?**
 ...
 - B) The reveal of the actual number lands harder when their gut estimate was too low (correct)
...
4. **What does the green horizontal line in Step 3 of the Solution diagram represent?**
 ...
 - B) The capital staying preserved while dividends are paid out from it (correct)
...
5. **The compelling contrast at the end - what's the monthly outlay difference for the worked example?**
 ...
 - B) $6,800/mth (save) vs $1,700/mth (invest) (correct)
...
6. **In the door-opener at the end, what's the right move?**
 ...
 - B) Ask permission for a proper fact-find - no product yet (correct)
...
7. **Which compliance line MUST go in front of any number you write?**
 ...
 - B) "Returns are illustrative averages, not guarantees" (correct)
