...
![From exploration to intensification: Situation, Neutral; Problem, Slight unease; Implication, Real concern; Implication, Explicit, felt need; Need-Payoff, Hopeful; Close, Decisive.](/first-60-days/images/day-49-m0.webp)
...
![The Colombo Close - the transition out: SPIN arc complete, Need-Payoff answered; Colombo Close, Name goals + budget; Client response; No reason why not, = Disguised yes; Needs spouse check, = Real info to handle; Raises objection X, = Gold - address now; Schedule next meeting, 90% pre-closed; Resolv](/first-60-days/images/day-49-m1.webp)
...
1. **Implication Questions are designed to:**
   ...
   - B) Make the client feel the consequences of NOT solving the problem (correct)
...
2. **The most powerful thing about a Need-Payoff Question:**
   ...
   - B) The client describes the benefits in their own words (correct)
...
3. **The Colombo Close is used:**
   ...
   - C) As the transition from SPIN into scheduling the next meeting + surfacing remaining objections (correct)
...
4. **A client says "I know I should save more for retirement but haven't started." You've acknowledged the problem. What's the correct next move?**
   ...
   - C) Ask an Implication question to make them feel the consequences of not starting (correct)
...
5. **You've just asked three Implication questions in a row. The client looks uncomfortable. What should you do?**
   ...
   - C) Pivot to a Need-Payoff question to shift the emotional tone toward the solution (correct)
...
6. **Which of these is a correctly framed Need-Payoff question?**
   ...
   - C) "What would it mean to you to know right now that your retirement plan is fully on track?" (correct)
...
7. **A client answers your Need-Payoff question with "It would be a huge relief - my wife worries about this too." What is the most important thing to do next?**
   ...
   - C) Wait for the full answer and let it sit - that sentence is the most valuable in the meeting (correct)
