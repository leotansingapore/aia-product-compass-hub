...
> **Source-script reference:** the entire numbers + budget section flows out of the **[Canned Sales Track](/learning-track/first-60-days/reference/cst-risks-script-full)** Page 2. Specifically the worked $3.5K-gross / $2.8K-take-home example, the 1/3 rule (short / medium / long), and the *"20% of take-home at 4-6% return is the magic number for retirement"* anchor. Read it before running this day's CFR conversation.

## What you'll walk away with

By the end of today you should be able to:

1. **Run** the financial numbers section of the CFR with calm, not anxiety.
2. **Collect** the 6 categories of financial data you actually need for a recommendation.
3. **Close** a CFR with a commitment to the next meeting using the Colombo-style close.

---

## 1. Why the numbers section matters
...
**Rule:** don't skip, skim, or avoid this section. It's awkward only because you let it be.

## 2. The "earning it" principle

By the time you reach Section 3, you've already:
...
## 3. The smooth transition into Section 3

Use this framing (paraphrase in your voice):

> "In order to plan for the future, we need to know where you are today. In simple terms: we need to know where we're starting from in order to know how to get to our destination. To do this, I need to ask one or two basic questions."
...
- Spouse's income (if applicable, for household planning).
- Income stability (stable salary vs variable commission, etc.).

**Probing question:** "Is this income pretty stable, or does it vary a lot month to month?"

### 2. Expenses
- Monthly essential expenses (housing, food, transport, utilities).
- Monthly lifestyle expenses (eating out, entertainment, subscriptions).
...
- Investments (ETFs, unit trusts, stocks, crypto).
...
- Critical illness (major + early, amounts).
- Hospitalisation (private / restructured, deductible).
- Disability income.
- Personal accident.
...
## 5. Handling resistance to numbers
...
### Objection: "I'll need to check with my spouse first."
> "Of course. Want to do Section 3 together next time? Or I can share what I need, and you bring the numbers to our next meeting. Whatever works."
