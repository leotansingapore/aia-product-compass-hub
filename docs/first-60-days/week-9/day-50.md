...
1. **The purpose of Section 1 of the CFR is:**
   ...
   - B) Pitch products
   - C) Get the client talking, spot implied needs, rank priorities (correct)
   - D) Negotiate price
...
2. **When transitioning from general discussion into Problem Questions:**
   ...
   - B) Ask permission first, signal the shift is to more personal questions (correct)
...
3. **After ranking goals, you start Problem Questions with:**
   - A) The easiest goal
   - B) The client's #1 priority - where emotional engagement is highest (correct)
...
4. **A client answers "Two kids, ages 6 and 4" and stops. What should you do?**
   ...
   - C) Probe with a follow-up - "Any thoughts on what you want for their future?" - to surface implied needs (correct)
...
5. **A client mentions 5 goals in passing. You haven't ranked them yet. What's the risk of jumping straight to Problem Questions?**
   ...
   - B) You may present solutions matched to the wrong priority and lose emotional engagement (correct)
...
6. **During Section 2, a client gives a shallow answer: "Yeah, I know I should do more for retirement." What do you do?**
   ...
   - C) Probe further: "How long has this been on your mind?" until a real problem is acknowledged (correct)
...
7. **You're mid-CFR and the client gets defensive when you begin Section 3. This most likely means:**
   ...
   - B) Sections 1 and 2 weren't done well enough to earn the trust required for financial disclosure (correct)
