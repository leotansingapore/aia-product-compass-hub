-- Fix the user approval process by updating the approve-user edge function logic
-- First, let's check the current state and fix any foreign key issues

-- Update the approve_user_request_simple function to handle the user creation properly
