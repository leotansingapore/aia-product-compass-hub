-- Update the approve_user_request_simple function to accept the approving user ID as a parameter
-- This fixes the permission issue when called from edge functions
