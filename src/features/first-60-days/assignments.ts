export type AssignmentFormFieldKind = "text" | "textarea" | "section" | "check" | "file";
...
const rawLoaders = import.meta.glob<string>(
  "/docs/first-60-days/assignments/assignment-*.md",
  { query: "?raw", import: "default" },
);

const PATH_RE = /\/docs\/first-60-days\/assignments\/(assignment-\d+)\.md$/;
