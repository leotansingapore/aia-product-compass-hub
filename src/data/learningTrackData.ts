    ...
    items: [
      ...
      },
      {
        ...
        defaultContent: [
          ...
          link("p2-2-b", "Knowledge Base — All Product Categories", "/kb"),
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    items: [
      ...
      },
      {
        ...
        defaultContent: [
          link("p4-2-a", "Knowledge Base — All Products", "/kb"),
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    items: [
      ...
      },
      {
        ...
        defaultContent: [
          link("p5-2-a", "KB — Medical Insurance Products", "/kb/medical-insurance"),
          link("p5-2-b", "KB — Term Products", "/kb/term-products"),
          link("p5-2-c", "KB — Whole Life Products", "/kb/whole-life-products"),
          link("p5-2-d", "KB — Investment Products", "/kb/investment-products"),
          link("p5-2-e", "KB — Endowment Products", "/kb/endowment-products"),
