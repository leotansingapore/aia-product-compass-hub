...
export default function M9AModule({ embedded = false }: { embedded?: boolean } = {}) {
  ...
  if (loadError) {
    return <CMFASModuleLoadError moduleName="M9A" onRetry={loadData} embedded={embedded} />;
  }
  ...
  return (
    ...
    >
      ...
      {!embedded && <CMFASHubChatFAB moduleId="m9a" />}
    </div>
  );
}
