    ...
    tools: [
      {
        ...
        href: "https://content-studio-beige-eta.vercel.app",
        external: true,
        icon: Sparkles,
        badge: "New",
      },
...
function ToolCard({ tool }: { tool: Tool }) {
  ...
  const content = (
    <article
      className={cn(
        "group relative flex h-full flex-col gap-3 rounded-xl border bg-card p-5 shadow-sm transition-all",
...
export default function Tools() {
  return (
    <PageLayout
      title="Tools - FINternship"
      description="One hub for every standalone tool we've built for consultants. Bookmark them. Use them weekly."
    >
      <BrandedPageHeader
        tone="dark"
        showOnMobile
        title="Tools"
        subtitle="The apps that make your week easier"
        brandLogoSrc={null}
      />

      <div className="mx-auto max-w-6xl space-y-8 px-4 pb-16 pt-6 sm:px-6">
