...
const STARTERS: string[] = [
  "Took the time to fully explain my options and guide me in the right direction.",
  "Never felt pressured or treated like a sales target - more like talking to a trusted friend.",
  "Genuinely cares about clients and their well-being, not just making a sale.",
  "Professional and reliable from the first meeting to the last.",
  "Highly committed, with an outstanding work ethic and real integrity.",
  "Sincere and attentive - put genuine effort into a plan tailored to my needs.",
  "Gave me clear, honest information and helped me find cover that matched my needs and budget.",
  "Highly trustworthy - stays on top of my plan and gives me candid advice on improving my coverage.",
  "Friendly, confident and genuine, and always looks out for your interests.",
  "Patient with all my questions and never made me feel rushed.",
  "Honest enough to tell me when what I already had was fine and didn't need changing.",
  "Quick to respond whenever I had a question or a concern.",
  "Explained everything in plain language, so I finally understood what I was paying for.",
  "Followed up exactly when they said they would.",
  "Made a stressful, confusing topic feel simple and manageable.",
  "I'd recommend them to friends and family without hesitation.",
];
