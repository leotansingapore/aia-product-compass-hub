...
function CaseReferencePhotos({ caseId }: { caseId: string }) {
  ...
  // Photos for this case come from two sources:
  //  1) Static auto-matched JSON (built by tools/match-photos-to-cases.py)
  //  2) photo_case_tags table (admin-curated via /admin/assign-drawings)
  // Both are merged here; duplicates de-dup'd by URL.
