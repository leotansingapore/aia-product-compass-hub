...
export function FloatingAIChat({ productId, productName }: FloatingAIChatProps) {
  ...
  return (
    <>
      ...
      <div
          className={cn(
            "fixed z-[60] bg-background border rounded-xl shadow-2xl flex flex-col overflow-hidden",
            isMobile
      ...
      className={cn(
          "fixed z-[60] h-14 w-14 rounded-full shadow-lg transition-all duration-300 hover:scale-110",
