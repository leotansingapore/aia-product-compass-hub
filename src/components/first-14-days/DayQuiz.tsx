...
import type { QuizQuestion } from "@/features/first-14-days/types";
import { useFirst14DaysProgress, type DayProgress } from "@/hooks/first-14-days/useFirst14DaysProgress";

/** Progress interface — pass to override the default First 14 Days progress hook. */
...
type Props = {
  ...
  /** Override progress source. Defaults to First 14 Days. */
