...
import { Plus, Pencil, Trash2, CheckCircle2, Search, Loader2 } from 'lucide-react';
...
export function QuestionBankManager() {
  ...
  const { deleteQuestion, bulkDelete } = useQuestionBankAdmin();
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-2 mb-2">
                        ...
                        <span className="text-xs text-muted-foreground">Sort: {q.sort_order}</span>
                      </div>
